  ...
  */
  ...
  if (!request_login)
   alert("Вы используете устаревший браузер, пожалуйсте обновите его или установите современный браузер: Safary или Chrome");
  ...
  function form_loader(form_name, output)
  {
    ...
    {
      if (request_login.readyState == 4) // если запрос завершён
      {
        if (request_login.status == 200) // и ответ 200 ( не ошбка )
        {
